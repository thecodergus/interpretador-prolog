...
/* package Trabalho-PAP-0.1.0.0 */
#ifndef VERSION_Trabalho_PAP
#define VERSION_Trabalho_PAP "0.1.0.0"
#endif /* VERSION_Trabalho_PAP */
#ifndef MIN_VERSION_Trabalho_PAP
#define MIN_VERSION_Trabalho_PAP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Trabalho_PAP */
...
#define CURRENT_COMPONENT_ID "Trabalho-PAP-0.1.0.0-J4QVky9EkBIFtJh3quGMHw-Cabal-example"
